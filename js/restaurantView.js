class RestaurantView {
    constructor() {
        ...
        this.migas = document.getElementById("migas");
    }
    ...
    listCategories(categories, title) {
        ...
        const nodeToKeep = document.getElementById('migasIni');

        // Elimina todos los nodos secundarios directos del contenedor, excepto el nodo que deseas mantener
        this.migas.replaceChildren();

        this.migas.append(nodeToKeep);

        migas.insertAdjacentHTML('beforeend', `<li class="breadcrumb-item active" aria-current="page">Categorias</li>`);
    ...
    listAllergens(allergens, title) {
        ...
        migas.insertAdjacentHTML('beforeend', `<li class="breadcrumb-item active" aria-current="page">Alergenos</li>`);
    }
    ...
    listMenus(menus, title) {
        ...
        migas.insertAdjacentHTML('beforeend', `<li class="breadcrumb-item active" aria-current="page">Menu</li>`);
    }
    ...
    listRestaurant(restaurants, name) {
        ...
        migas.insertAdjacentHTML('beforeend', `<li class="breadcrumb-item active" aria-current="page">Restaurante</li>`);
    }
    ...
    showDetailsDishes(dish, message) {
        ...
        this.platos.append(container);
        migas.insertAdjacentHTML('beforeend', `<li class="breadcrumb-item active" aria-current="page">${dish.description}</li>`);
    }
